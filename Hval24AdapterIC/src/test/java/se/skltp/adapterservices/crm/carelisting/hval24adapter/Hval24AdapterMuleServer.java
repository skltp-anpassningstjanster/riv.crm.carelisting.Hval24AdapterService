...
public class Hval24AdapterMuleServer {


	public static final String MULE_SERVER_ID   = "Hval24Adapter";
 

	private static final Logger logger = LoggerFactory.getLogger(Hval24AdapterMuleServer.class);
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/Hval24Adapter-common.xml"
        //
