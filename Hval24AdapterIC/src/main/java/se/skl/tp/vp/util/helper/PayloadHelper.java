...
public class PayloadHelper extends VPHelperSupport {
	...
	public void positionBodyInPayload(final ReversibleXMLStreamReader reader) throws XMLStreamException {
		...
		while (reader.hasNext()) {
			...
			case XMLStreamConstants.END_ELEMENT:
				...
				if (local.equals("Body")) {
					throw new RuntimeException("No element found in soap body");
				}
